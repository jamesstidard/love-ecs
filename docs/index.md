...
@[code{1-1} lua](@tests/test_quick_start.lua)
...
@[code{2-2} lua](@tests/test_quick_start.lua)
...
@[code{4-24} lua](@tests/test_quick_start.lua)
...
@[code{26-37} lua](@tests/test_quick_start.lua)
...
@[code{39-58} lua](@tests/test_quick_start.lua)
...
@[code{60-77} lua](@tests/test_quick_start.lua)
